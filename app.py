...
# --------------------------
# 3. Comet Contract Setup (USDC market)
# --------------------------
...
# --------------------------
# 4. Get ETH Collateral Factors + Price
# --------------------------
...
eth_price = eth_price_raw / 1e8  # Chainlink returns 8 decimals
